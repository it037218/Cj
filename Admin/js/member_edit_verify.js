    ...
    $(".verify-yes").on("click",function(){
        ...
        if(user_id.length == 0){
            ...
            $.post(
                ...
                "member.php?action=editVerifyResult",
                {
                    user_id:user_id,
                    verify_result:1
                },
    ...
    $.post(
        ...
        function(data){
            if(data != null){
                ...
                var content = '<tr><td>真实姓名：'+dataObj.realname+'</td><td>手机号：'+dataObj.telephone+'</td><td>身份证号：'+dataObj.card_number+'</td></tr>'+
